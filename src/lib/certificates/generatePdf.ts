...
interface TechnicianData {
  ...
  isAvailable: boolean
  /** Aparecen como pills en OPERATIONAL FLAGS del certificado AMX */
  experienceAmos?: boolean
  experienceTrax?: boolean
}
...
export async function generateCertificatePdf(data: CertificateData): Promise<Uint8Array> {
  ...
  if (data.technician.experienceAmos) flags.push('AMOS experience')
  if (data.technician.experienceTrax) flags.push('TRAX experience')
